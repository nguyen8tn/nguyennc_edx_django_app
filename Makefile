...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd nguyennc_edx_django_app && ../manage.py makemessages -l en -v1 -d django
	cd nguyennc_edx_django_app && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd nguyennc_edx_django_app && ../manage.py compilemessages

detect_changed_source_translations:
	cd nguyennc_edx_django_app && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd nguyennc_edx_django_app && i18n_tool dummy
