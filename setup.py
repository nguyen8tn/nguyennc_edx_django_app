#!/usr/bin/env python
"""
Package metadata for nguyennc_edx_django_app.
"""
import os
import re
import sys
...
VERSION = get_version('nguyennc_edx_django_app', '__init__.py')
...
setup(
    ...
    author='NguyenNC edX App',
    author_email='nguyen8tn@gmail.com',
    url='https://github.com/nguyen8tn/nguyennc_edx_django_app',
    packages=find_packages(
        include=['nguyennc_edx_django_app', 'nguyennc_edx_django_app.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "nguyennc_edx_django_app = nguyennc_edx_django_app.apps:NguyenncEdxDjangoAppConfig",
        ],
        "cms.djangoapp": [
            "nguyennc_edx_django_app = nguyennc_edx_django_app.apps:NguyenncEdxDjangoAppConfig",
        ],
