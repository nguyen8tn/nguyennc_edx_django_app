...
"""
nguyennc_edx_django_app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'nguyennc_edx_django_app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/nguyen8tn/nguyennc_edx_django_app",
...
#
# html_title = 'nguyennc_edx_django_app v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'nguyennc_edx_django_app'),
                os.path.join(root_path, 'nguyennc_edx_django_app/migrations')])
